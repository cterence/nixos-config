...
in
{
  ...
  # FIXME: Audio randomly stopped working after booting, a workaround is to restart the PipeWire service after gnome session loaded.
  systemd.user.services.pipewire-restart = {
    ...
    Service = {
      ExecStart = "${pkgs.writeShellScript "pipewire-restart" ''
